...
function Hero() {
  return (
    <header className="bg-[url(header.jpg)] bg-bottom-right bg-contain bg-no-repeat lg:bg-cover lg:bg-center h-dvh flex items-center md:pl-[10%] max-md:justify-center">
      <div>
