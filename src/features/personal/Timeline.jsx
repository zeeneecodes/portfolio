          ...
          <ol>
            ...
            <li className="entry">
              ...
              <p>
                ...
                manipulation. Focused on mini-projects to practice problem
                solving and code organization.
              </p>
            </li>
            <li className="entry">
              <h3>2024, Late</h3>
            ...
            <li className="entry">
              ...
              <small className="title">@Professional Development</small>
              <p>
                Enrolled in a structured React course (Udemy). Practiced
                component design, state management, routing, and practical UI
                patterns.
              </p>
            </li>
