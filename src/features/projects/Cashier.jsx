      ...
      <div className="max-w-5xl flex flex-col justify-center px-6 gap-20 items-stretch">
        ...
        <section>
          <Content heading="h2" title="Overview">
            <p>
              This is a school project that I created for a friend's sibling. As
              the title says, this is a very basic cashier type calculator that
              does not require anything other than the use of vanilla HTML, CSS,
              and JavaScript.
            </p>
          </Content>
